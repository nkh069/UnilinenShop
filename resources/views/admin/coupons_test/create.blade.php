...
@section('title', 'Thêm mã giảm giá test mới')

@section('content')
<div class="container-fluid px-4">
    <h1 class="mt-4">Thêm mã giảm giá test mới</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.coupons.index') }}">Mã giảm giá</a></li>
        <li class="breadcrumb-item active">Thêm mã giảm giá test</li>
    </ol>

    <div class="card mb-4">
        <div class="card-header">
            <i class="fas fa-tag me-1"></i>
            Thông tin mã giảm giá (Mã này sẽ không hoạt động khi áp dụng)
        </div>
        <div class="card-body">
            <form action="{{ route('admin.coupons_test.store') }}" method="POST">
                @csrf
                ...
                <div class="mt-4 d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-1"></i> Lưu mã giảm giá test
                    </button>
                </div>
            </form>
        </div>
