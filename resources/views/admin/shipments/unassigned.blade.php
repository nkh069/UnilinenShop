...
@section('title', 'Đơn Vận Chuyển Chưa Phân Công')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Đơn Vận Chuyển Chưa Phân Công</h3>
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.shipments.unassigned') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                ...
                                <a href="{{ route('admin.shipments.unassigned') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> Không có đơn vận chuyển nào chưa được phân công.
                    </div>
                    @endif
                </div>
            </div>
